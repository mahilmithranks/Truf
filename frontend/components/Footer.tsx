                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <p className="text-gray-300 text-sm leading-relaxed max-w-md">
                                The easiest way to book your favorite turf. Instant confirmation, secure payments, and 24/7 support for all your sports needs.
                            </p>
                        </div>

                        {/* Quick Links */}
                        <div>
                            <h4 className="text-white font-semibold text-sm uppercase mb-4 tracking-wider">Quick Links</h4>
                            <div className="flex flex-col gap-2">
                                <Link href="/book" className="text-gray-300 hover:text-white text-sm transition-colors">
                                    Book Now
                                </Link>
                                <Link href="/my-bookings" className="text-gray-300 hover:text-white text-sm transition-colors">
                                    My Bookings
                                </Link>
                        ...
                        {/* Contact */}
                        <div>
                            <h4 className="text-white font-semibold text-sm uppercase mb-4 tracking-wider">Contact</h4>
                ...
                <div className="mt-8 pt-6 border-t border-white/10">
                    ...
                    <div className="text-center pt-4 border-t border-white/10">
                        <p className="text-sm text-gray-400">
                            Developed by{' '}
                            <a
                                href="https://zenvoa-technologies.vercel.app/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-white hover:text-blue-400 font-medium transition-colors underline decoration-dotted"
                            >
                                Zenvoa Technologies
                            </a>
                        </p>
